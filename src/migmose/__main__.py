...
def main(
    ...
    for m_format, file in dict_files.items():
        ...
        (raw_lines, segmentlayouts) = parse_raw_nachrichtenstrukturzeile(file)
        ...
        if "tree" in file_type:
            ...
            reduced_nested_nachrichtenstruktur.to_tree(m_format, output_dir_for_format, segmentlayouts)
